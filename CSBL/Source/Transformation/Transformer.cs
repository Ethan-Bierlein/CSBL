...
namespace CSBL.Transformation
{
    ...
    public class Transformer
    {
        ...
        private List<string> GlobalOptions { get; set; }

        /// <summary>
        /// Constructor for the Transformer class.
        /// </summary>
        /// <param name="inputTokens">The tokens to be transformed, provided by the tokenizer.</param>
        /// <param name="options">A list of global options generated by the preprocessor.</param>
        public Transformer(List<Token> inputTokens, List<string> options)
        {
        ...
        {
            Stopwatch transformerStopwatch = new Stopwatch();
            ...
            if(this.GlobalOptions.Contains("ENABLE_STAGE_TIMING_OUTPUT"))
            {
                ...
                Console.WriteLine(
                    "[TIMING::Transformer] Stage took {0}s / {1}ms / {2}t.",
                    transformerStopwatch.Elapsed,
                    transformerStopwatch.ElapsedMilliseconds,
                    transformerStopwatch.ElapsedTicks
                );
                Console.ResetColor();
            }
            ...
            {
                Errors.ExitTransformer.Report("", 0, 0);
            }
