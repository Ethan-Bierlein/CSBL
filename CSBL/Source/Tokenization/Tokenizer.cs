...
namespace CSBL.Tokenization
{
    ...
    public class Tokenizer
    {
        ...
        public Tokenizer(string inputString, List<string> options, params TokenDefinition[] tokenDefinitions)
        {
        ...
        {
            Stopwatch tokenizerStopwatch = new Stopwatch();
            tokenizerStopwatch.Start();
            ...
            if(this.GlobalOptions.Contains("ENABLE_STAGE_TIMING_OUTPUT"))
            {
                ...
                Console.WriteLine(
                    "[TIMING::Tokenizer] Stage took {0}s / {1}ms / {2}t.",
                    tokenizerStopwatch.Elapsed,
                    tokenizerStopwatch.ElapsedMilliseconds,
                    tokenizerStopwatch.ElapsedTicks
                );
                Console.ResetColor();
            }
            ...
            {
                Errors.ExitTokenizer.Report("", 0, 0);
            }
